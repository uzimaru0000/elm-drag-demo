...
var author$project$Point$decoder = function (_n0) {
	var x = _n0.a;
	var y = _n0.b;
	return A3(
		elm$json$Json$Decode$map2,
		author$project$Point$Point,
		A2(elm$json$Json$Decode$at, x, elm$json$Json$Decode$int),
		A2(elm$json$Json$Decode$at, y, elm$json$Json$Decode$int));
};
...
var author$project$Main$subscriptions = function (model) {
	return (!_Utils_eq(model.ref, elm$core$Maybe$Nothing)) ? elm$browser$Browser$Events$onMouseMove(
		A2(
			elm$json$Json$Decode$map,
			author$project$Model$Drag,
			author$project$Point$decoder(
				_Utils_Tuple2(
					_List_fromArray(
						['movementX']),
					_List_fromArray(
						['movementY']))))) : elm$core$Platform$Sub$none;
};
var author$project$Model$Model = F2(
	function (entities, ref) {
		return {entities: entities, ref: ref};
	});
var author$project$Model$Entity$Entity = F2(
	function (a, b) {
		return {$: 'Entity', a: a, b: b};
	});
var author$project$Model$Entity$Note = function (a) {
	return {$: 'Note', a: a};
};
var author$project$Model$Entity$Sticky = function (a) {
	return {$: 'Sticky', a: a};
};
	...
	return _Utils_Tuple2(
		A2(
			...
			_List_fromArray(
				[
					A2(
					author$project$Model$Entity$Entity,
					{
						pos: A2(author$project$Point$Point, 100, 100),
						size: A2(author$project$Point$Point, 300, 300)
					},
					author$project$Model$Entity$Note(
						_List_fromArray(
							[
								A2(
								author$project$Model$Entity$Entity,
								{
									pos: A2(author$project$Point$Point, 20, 20),
									size: A2(author$project$Point$Point, 100, 100)
								},
								author$project$Model$Entity$Sticky('child')),
								A2(
								author$project$Model$Entity$Entity,
								{
									pos: A2(author$project$Point$Point, 150, 20),
									size: A2(author$project$Point$Point, 100, 100)
								},
								author$project$Model$Entity$Sticky('child'))
							])))
...
var arowM$elm_reference$Reference$Reference = function (a) {
	return {$: 'Reference', a: a};
};
var arowM$elm_reference$Reference$fromRecord = arowM$elm_reference$Reference$Reference;
var arowM$elm_reference$Reference$rootWith = function (_n0) {
	var o = _n0.a;
	return o.rootWith;
};
var arowM$elm_reference$Reference$this = function (_n0) {
	var o = _n0.a;
	return o._this;
};
var arowM$elm_reference$Reference$modify = F2(
	function (f, ref) {
		return arowM$elm_reference$Reference$fromRecord(
			{
				rootWith: arowM$elm_reference$Reference$rootWith(ref),
				_this: f(
					arowM$elm_reference$Reference$this(ref))
			});
	});
var arowM$elm_reference$Reference$root = function (ref) {
	return A2(
		arowM$elm_reference$Reference$rootWith,
		ref,
		arowM$elm_reference$Reference$this(ref));
};
...
var author$project$Model$Entity$move = F2(
	function (movement, _n0) {
		...
		return A2(
			...
			_Utils_update(
				transform,
				{
					pos: A2(author$project$Point$add, pos, movement)
				}),
			content);
	});
...
var author$project$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Drag':
				var p = msg.a;
				var updatedReference = A2(
					elm$core$Maybe$map,
					arowM$elm_reference$Reference$modify(
						author$project$Model$Entity$move(p)),
					model.ref);
				var a = A2(elm$core$Debug$log, '', p);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							entities: A2(
								...
								model.entities,
								A2(elm$core$Maybe$map, arowM$elm_reference$Reference$root, updatedReference)),
...
var arowM$elm_reference$Reference$top = function (a) {
	return arowM$elm_reference$Reference$fromRecord(
		{rootWith: elm$core$Basics$identity, _this: a});
};
var arowM$elm_reference$Reference$List$unwrap_ = F3(
	function (past, f, ref) {
		var _n0 = arowM$elm_reference$Reference$this(ref);
		if (!_n0.b) {
			return _List_Nil;
		} else {
			var x = _n0.a;
			...
			return A2(
				elm$core$List$cons,
				f(
					arowM$elm_reference$Reference$fromRecord(
						{
							rootWith: function (a) {
								return A2(
									arowM$elm_reference$Reference$rootWith,
				...
				A3(
					arowM$elm_reference$Reference$List$unwrap_,
					A2(
...
var arowM$elm_reference$Reference$List$unwrap = arowM$elm_reference$Reference$List$unwrap_(elm$core$Basics$identity);
...
var author$project$Utils$stopPropagationOn = F2(
	function (name, msg) {
...
var author$project$View$transformAttr = function (style) {
	return _List_fromArray(
		[
			mdgriffith$elm_ui$Element$moveDown(style.pos.y),
			mdgriffith$elm_ui$Element$moveRight(style.pos.x),
			mdgriffith$elm_ui$Element$width(
			mdgriffith$elm_ui$Element$px(style.size.x)),
			mdgriffith$elm_ui$Element$height(
			mdgriffith$elm_ui$Element$px(style.size.y))
		]);
};
...
var author$project$View$entityView = function (ref) {
	var commonAttrs = function (transform) {
		return _Utils_ap(
			author$project$View$transformAttr(transform),
			_List_fromArray(
				[
					A2(author$project$Utils$stopPropagationOn, 'mouseup', author$project$Model$End),
					A2(
					author$project$Utils$stopPropagationOn,
					'mousedown',
					author$project$Model$Select(ref)),
		...
		return mdgriffith$elm_ui$Element$inFront(
			A2(
				...
				_Utils_ap(
					...
					_Utils_ap(
						A2(
							arowM$elm_reference$Reference$List$unwrap,
							author$project$View$entityView,
							arowM$elm_reference$Reference$fromRecord(
								{
									rootWith: A2(
										elm$core$Basics$composeL,
										A2(
											elm$core$Basics$composeL,
											arowM$elm_reference$Reference$rootWith(ref),
											author$project$Model$Entity$Entity(transform)),
										author$project$Model$Entity$Note),
									_this: entities
								})),
						_List_fromArray(
							[
								...
								A3(mdgriffith$elm_ui$Element$rgb, 0.2, 1.0, 0.5))
							]))),
			...
			A2(
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							mdgriffith$elm_ui$Element$Background$color(
							A3(mdgriffith$elm_ui$Element$rgb, 0.2, 0.5, 1.0))
						])),
...
var author$project$View$view = function (model) {
	return A2(
		...
		A2(
			arowM$elm_reference$Reference$List$unwrap,
			author$project$View$entityView,
			arowM$elm_reference$Reference$top(model.entities)),
		_List_Nil);
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Model.Msg","aliases":{"Point.Point":{"args":[],"type":"{ x : Basics.Int, y : Basics.Int }"},"Model.Entity.Transform":{"args":[],"type":"{ pos : Point.Point, size : Point.Point }"}},"unions":{"Model.Msg":{"args":[],"tags":{"Select":["Reference.Reference Model.Entity.Entity (List.List Model.Entity.Entity)"],"Drag":["Point.Point"],"End":[]}},"Reference.Reference":{"args":["a","root"],"tags":{"Reference":["{ this : a, rootWith : a -> root }"]}},"Model.Entity.Entity":{"args":[],"tags":{"Entity":["Model.Entity.Transform","Model.Entity.Content"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Model.Entity.Content":{"args":[],"tags":{"Note":["List.List Model.Entity.Entity"],"Sticky":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
